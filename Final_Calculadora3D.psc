...
SubProceso llenarMatriz_Z0(calculadora, cadena1)
	Definir i, j, posicionCadena Como Entero
	posicionCadena = 0
	para i = 0 Hasta  2 Hacer
		para j = 0 Hasta 2 Hacer
			calculadora(0,i,j) = ConvertirANumero(( Subcadena(cadena1, posicionCadena, posicionCadena)))
...
SubProceso llenarMatriz_Z1(calculadora, cadena2)
	...
	para i = 0 Hasta  2 Hacer
		para j = 0 Hasta 2 Hacer
			calculadora(1,i,j) = ConvertirANumero(( Subcadena(cadena2, posicionCadena, posicionCadena)))
			posicionCadena= posicionCadena + 1
		FinPara
	FinPara
